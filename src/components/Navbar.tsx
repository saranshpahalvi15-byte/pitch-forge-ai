...
interface NavbarProps {
  currentView: 'dashboard' | 'intake' | 'analysis' | 'studio' | 'score' | 'critique' | 'settings';
  setCurrentView: (view: 'dashboard' | 'intake' | 'analysis' | 'studio' | 'score' | 'critique' | 'settings') => void;
...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-zinc-800 bg-zinc-950/90 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
          ...
          >
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="hidden sm:inline-flex items-center rounded-md bg-zinc-800 px-1.5 py-0.5 text-[10px] font-medium text-zinc-400 border border-zinc-700">
                  Firebase • Gemini
                </span>
              </div>
              <p className="text-[11px] text-zinc-400 hidden sm:block">
                From raw idea to investor-ready story
              </p>
            </div>
          </button>
        ...
        <div className="flex items-center gap-2.5">
            ...
            <div className="relative">
              {user ? (
                <button
                  ...
                  className="flex items-center gap-2 rounded-lg bg-zinc-900 border border-zinc-700/80 px-2 py-1 text-xs hover:border-amber-500/40 transition-all cursor-pointer"
                ...
                >
                  ...
                  <span className="hidden lg:inline text-zinc-300 max-w-[100px] truncate text-[11px] font-medium">
          ...
          <button
            ...
            title="Google Cloud Architecture & Firebase Settings"
      ...
      {authError && (
        <div className="bg-rose-500/20 text-rose-300 px-4 py-1.5 text-xs text-center border-b border-rose-500/30 flex items-center justify-center justify-between">
